...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'prov_email' => 'required|string|max:200|email:rfc|unique:providers',
    ...
    {
        return [
            'prov_name.required' => 'NOMBRE, Este campo es requerido.',
            'prov_name.string' => 'NOMBRE, El valor no es correcto.',
            'prov_name.max' => 'NOMBRE, Solo se permitan 255 caracteres.',
            // 'prov_name.unique' => 'El proveedor se encuentra registrado.',
